              ...
              <View key={quiz.id} style={styles.quizItem}>
                {editQuiz?.id === quiz.id ? (
                  ...
                  <View>
                    ...
                    <View style={styles.row}>
                      <TouchableOpacity style={[styles.actionBtn, { backgroundColor: '#334155', marginRight: 8 }]} onPress={() => handleEdit(quiz)}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, color: '#6366f1', fontWeight: '700' },
  subtitle: { fontSize: 16, color: '#94a3b8', marginBottom: 10 },
  logoutBtn: { padding: 8 },
  logoutText: { color: '#ef4444', fontSize: 14, fontWeight: '600' },
  tabRow: { flexDirection: 'row', marginBottom: 20, backgroundColor: '#1e293b', borderRadius: 10, padding: 4 },
  tab: { flex: 1, padding: 12, alignItems: 'center', borderRadius: 8 },
  tabActive: { backgroundColor: '#4f46e5' },
  tabText: { color: '#94a3b8', fontSize: 13, fontWeight: '600' },
  tabTextActive: { color: '#fff' },
  card: { backgroundColor: '#1e293b', borderRadius: 20, padding: 20, marginBottom: 20 },
  cardTitle: { color: '#fff', fontSize: 18, marginBottom: 15, fontWeight: '700' },
  label: { color: '#94a3b8', fontSize: 14, marginBottom: 8, fontWeight: '600' },
  input: { backgroundColor: '#0f172a', borderRadius: 10, padding: 15, color: '#fff', fontSize: 16, marginBottom: 15 },
  chip: { backgroundColor: '#0f172a', borderRadius: 20, paddingHorizontal: 15, paddingVertical: 8, marginRight: 8 },
  chipActive: { backgroundColor: '#4f46e5' },
  chipText: { color: '#94a3b8', fontSize: 13 },
  chipTextActive: { color: '#fff' },
  row: { flexDirection: 'row', marginBottom: 15 },
  numBtn: { flex: 1, backgroundColor: '#0f172a', borderRadius: 10, padding: 12, alignItems: 'center', marginRight: 5 },
  numBtnActive: { backgroundColor: '#4f46e5' },
  numBtnText: { color: '#94a3b8', fontSize: 16 },
  ...
  noData: { color: '#64748b', textAlign: 'center', fontSize: 14, padding: 20 },
  quizItem: { backgroundColor: '#0f172a', borderRadius: 10, padding: 15, marginBottom: 10 },
  quizTitle: { color: '#fff', fontSize: 16, marginBottom: 4, fontWeight: '700' },
  quizMeta: { color: '#94a3b8', fontSize: 12, marginBottom: 10 },
  ...
  questionFormBox: { backgroundColor: '#0f172a', borderRadius: 12, padding: 12, marginBottom: 15 },
  questionHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  questionLabel: { color: '#6366f1', fontSize: 14, fontWeight: '700' },
  removeBtn: { padding: 4 },
  removeBtnText: { color: '#ef4444', fontSize: 12, fontWeight: '600' },
  optionInputRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  optionIndicator: { width: 28, height: 28, borderRadius: 6, backgroundColor: '#1e293b', alignItems: 'center', justifyContent: 'center', marginRight: 8 },
  optionIndicatorActive: { backgroundColor: '#10b981' },
  optionIndicatorText: { color: '#94a3b8', fontSize: 12, fontWeight: '700' },
  optionIndicatorTextActive: { color: '#fff' },
  optionInput: { flex: 1, backgroundColor: '#1e293b', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, color: '#fff', fontSize: 14 },
  correctSelectBtn: { marginLeft: 8, paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#1e293b', borderRadius: 8 },
  correctSelectBtnActive: { backgroundColor: '#10b981' },
  correctSelectBtnText: { color: '#94a3b8', fontSize: 12, fontWeight: '700' },
