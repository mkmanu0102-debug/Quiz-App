              ...
              <View key={quiz.id} style={styles.quizItem}>
                {editQuiz?.id === quiz.id ? (
                  ...
                  <View>
                    ...
                    <View style={styles.row}>
                      <TouchableOpacity style={[styles.actionBtn, { backgroundColor: '#475569', marginRight: 8 }]} onPress={() => handleEdit(quiz)}>
                        <Text style={styles.actionBtnText}>✏️ Edit</Text>
                      </TouchableOpacity>
                      <TouchableOpacity style={[styles.actionBtn, { backgroundColor: '#ef4444' }]} onPress={() => handleDelete(quiz.id)}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, color: '#0f172a', fontWeight: '800' },
  subtitle: { fontSize: 16, color: '#64748b', marginBottom: 10 },
  logoutBtn: { padding: 8 },
  logoutText: { color: '#ef4444', fontSize: 14, fontWeight: '600' },
  tabRow: { flexDirection: 'row', marginBottom: 20, backgroundColor: '#f1f5f9', borderRadius: 10, padding: 4, borderWidth: 1, borderColor: '#e2e8f0' },
  tab: { flex: 1, padding: 12, alignItems: 'center', borderRadius: 8 },
  tabActive: { backgroundColor: '#4f46e5' },
  tabText: { color: '#64748b', fontSize: 13, fontWeight: '600' },
  tabTextActive: { color: '#fff' },
  card: { backgroundColor: '#ffffff', borderRadius: 20, padding: 20, marginBottom: 20, borderWidth: 1, borderColor: '#e2e8f0', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 15, elevation: 2 },
  cardTitle: { color: '#0f172a', fontSize: 18, marginBottom: 15, fontWeight: '700' },
  label: { color: '#475569', fontSize: 14, marginBottom: 8, fontWeight: '600' },
  input: { backgroundColor: '#ffffff', borderRadius: 10, padding: 15, color: '#0f172a', fontSize: 16, marginBottom: 15, borderWidth: 1, borderColor: '#cbd5e1' },
  chip: { backgroundColor: '#f1f5f9', borderRadius: 20, paddingHorizontal: 15, paddingVertical: 8, marginRight: 8, borderWidth: 1, borderColor: '#e2e8f0' },
  chipActive: { backgroundColor: '#4f46e5', borderColor: '#4f46e5' },
  chipText: { color: '#475569', fontSize: 13 },
  chipTextActive: { color: '#fff' },
  row: { flexDirection: 'row', marginBottom: 15 },
  numBtn: { flex: 1, backgroundColor: '#f1f5f9', borderRadius: 10, padding: 12, alignItems: 'center', marginRight: 5, borderWidth: 1, borderColor: '#e2e8f0' },
  numBtnActive: { backgroundColor: '#4f46e5', borderColor: '#4f46e5' },
  numBtnText: { color: '#475569', fontSize: 16 },
  ...
  noData: { color: '#94a3b8', textAlign: 'center', fontSize: 14, padding: 20 },
  quizItem: { backgroundColor: '#f8fafc', borderRadius: 10, padding: 15, marginBottom: 10, borderWidth: 1, borderColor: '#e2e8f0' },
  quizTitle: { color: '#0f172a', fontSize: 16, marginBottom: 4, fontWeight: '700' },
  quizMeta: { color: '#64748b', fontSize: 12, marginBottom: 10 },
  actionBtn: { flex: 1, borderRadius: 8, padding: 10, alignItems: 'center' },
  actionBtnText: { color: '#fff', fontSize: 14, fontWeight: '600' },
  
  // Custom manual quiz styles
  divider: { height: 1, backgroundColor: '#e2e8f0', marginVertical: 20 },
  sectionHeader: { color: '#0f172a', fontSize: 16, fontWeight: '700', marginBottom: 15 },
  questionFormBox: { backgroundColor: '#f8fafc', borderRadius: 12, padding: 12, marginBottom: 15, borderWidth: 1, borderColor: '#e2e8f0' },
  questionHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  questionLabel: { color: '#4f46e5', fontSize: 14, fontWeight: '700' },
  removeBtn: { padding: 4 },
  removeBtnText: { color: '#ef4444', fontSize: 12, fontWeight: '600' },
  optionInputRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  optionIndicator: { width: 28, height: 28, borderRadius: 6, backgroundColor: '#f1f5f9', alignItems: 'center', justifyContent: 'center', marginRight: 8, borderWidth: 1, borderColor: '#e2e8f0' },
  optionIndicatorActive: { backgroundColor: '#10b981', borderColor: '#10b981' },
  optionIndicatorText: { color: '#475569', fontSize: 12, fontWeight: '700' },
  optionIndicatorTextActive: { color: '#fff' },
  optionInput: { flex: 1, backgroundColor: '#ffffff', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, color: '#0f172a', fontSize: 14, borderWidth: 1, borderColor: '#cbd5e1' },
  correctSelectBtn: { marginLeft: 8, paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#f1f5f9', borderRadius: 8, borderWidth: 1, borderColor: '#e2e8f0' },
  correctSelectBtnActive: { backgroundColor: '#10b981', borderColor: '#10b981' },
  correctSelectBtnText: { color: '#475569', fontSize: 12, fontWeight: '700' },
  correctSelectBtnTextActive: { color: '#fff' },
  addQuestionBtn: { borderStyle: 'dashed', borderWidth: 1, borderColor: '#4f46e5', borderRadius: 10, padding: 12, alignItems: 'center', marginBottom: 20 },
  addQuestionBtnText: { color: '#4f46e5', fontSize: 14, fontWeight: '700' },
});